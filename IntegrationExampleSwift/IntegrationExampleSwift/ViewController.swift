...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        itechpspSDK.presentPayment(at: self, paymentInfo: paymentInfo) { (result) in
            print("itechpspSDK finished with status \(result.status.rawValue)")
