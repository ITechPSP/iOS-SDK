...
//  Copyright © 2019 ITechPSP. All rights reserved.
//

#import "ViewController.h"
#import "IntegrationExampleObjc-Swift.h"
#import <itechpspSDK/ItechpspSDK.h>

#define SECRET @"your_secret"
#define PROJECT_ID 10 // your project id

@interface ViewController ()
@property (nonatomic, strong) ItechpspSDK *itechpspSDK;
@end
...
- (void)viewDidLoad {
    ...
    // Init SDK
    self.itechpspSDK = [[ItechpspSDK alloc] init];
    ...
    [self.itechpspSDK presentPaymentAt:self paymentInfo:paymentInfo completionHandler:^(ItechpspPaymentResult *result) {
        NSLog(@"itechpspSDK finished with status %ld", (long)result.status);
...
//    theme.showDarkKeyboard = true;
    [self.itechpspSDK setTheme:theme];
}
